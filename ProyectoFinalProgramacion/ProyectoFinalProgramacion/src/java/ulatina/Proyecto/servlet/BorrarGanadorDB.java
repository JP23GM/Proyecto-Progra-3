 ...
 * @author Julian
 */
@WebServlet(name = "BorrarGanadorDB", urlPatterns = {"/BorrarGanadorDB"})
public class BorrarGanadorDB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "DELETE FROM APP.GANADORES WHERE CEDULA = '" + id + "'";
